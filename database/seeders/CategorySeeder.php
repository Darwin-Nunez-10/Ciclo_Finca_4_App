...
class CategorySeeder extends Seeder
{
    public function run(): void
    {
        $categories = [
            ...
            ['name' => 'Componentes', 'description' => 'Componentes y repuestos de bicicleta', 'parent_category_id' => null],
            ['name' => 'Accesorios', 'description' => 'Accesorios y equipamiento para ciclismo', 'parent_category_id' => null],
            ['name' => 'Ropa deportiva', 'description' => 'Ropa especializada para ciclismo', 'parent_category_id' => null],
